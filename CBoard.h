...
class CBoard
{
    public:
        ...
        int  get_value();//get the leaf not value
        bool IsMoveValid(CMove &move) const; // Check weather move is valid or not
        ...
        friend std::ostream& operator <<(std::ostream &os, const CBoard &rhs);//User define manipulator and stream overloading
