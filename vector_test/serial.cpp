...
void ser::delay(int time_in_sec)
{
...
void ser::hover_the_box(int row, int column)
{
...
void ser::go_down(int row, int column)
{
...
void ser::major_task(int from_row,int from_col,int to_row,int to_col)
{
